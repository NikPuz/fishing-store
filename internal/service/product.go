...
func (s productService) ReadProduct(ctx context.Context, id int) (*entity.Product, error) {
...
func (s productService) ReadProducts(ctx context.Context) ([]entity.Product, error) {
